...
<qgis minScale="1e+08" maxScale="0" hasScaleBasedVisibilityFlag="0" version="3.16.11-Hannover" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" type="singlebandpseudocolor" classificationMax="1" classificationMin="-1" nodataColor="" band="1" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader minimumValue="-1" colorRampType="INTERPOLATED" maximumValue="1" labelPrecision="2" clip="0" classificationMode="1">
          ...
          <item alpha="255" color="#d7191c" value="-1" label="-1.00"/>
          <item alpha="255" color="#fdae61" value="-0.5" label="-0.50"/>
          <item alpha="255" color="#ffffbf" value="0" label="0.00"/>
          <item alpha="255" color="#abdda4" value="0.5" label="0.50"/>
  ...
  <originalStyle>
    <maplayer refreshOnNotifyEnabled="0" minScale="1e+08" maxScale="0" refreshOnNotifyMessage="" autoRefreshTime="0" type="raster" autoRefreshEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories">
      ...
      <id>Acarbo_hsm_diff_rcp45_626bc855_a314_41ce_b800_393c02eb3d2f</id>
      <datasource>../hsm/nc/diffhsm/Acarbo_hsm_diff_rcp45.nc</datasource>
      <keywordList>
        <value/>
      </keywordList>
      <layername>Acarbo_hsm_diff_rcp45</layername>
      <srs>
        <spatialrefsys>
          <wkt/>
          <proj4/>
