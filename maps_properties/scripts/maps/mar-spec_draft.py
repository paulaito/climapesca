...
def mspec_layout(mspec_dir, final_dir, template, type, title, small_title):
    ...
    for current_mspec in os.listdir(mspec_dir):
        if current_mspec.endswith(".nc"):
            ...
            # difference '45' or '85'
            if small_title.endswith("diff_rcp45"):
                layout.itemById("rcp").setText("45")
            if small_title.endswith("diff_rcp85"):
...
# rcp 45
mspec = "C:/Users/pa-ak/Documents/UAlg/CLIMA-PESCA/maps/spec/nc/rcp85/teste/"
final = "C:/Users/pa-ak/Documents/UAlg/CLIMA-PESCA/maps/SPEC_final/rcp85/"
tmp = "C:/Users/pa-ak/Documents/UAlg/CLIMA-PESCA/maps/layout/template/mar-spec/mar-spec_presentRcp.qpt"
ttl = "RCP 85"

mspec_layout(hsm, final, tmp, "Especialização", ttl, "spec_rcp85")
