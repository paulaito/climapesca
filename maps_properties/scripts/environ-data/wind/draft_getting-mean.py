...
dir = "C:/Users/pa-ak/Documents/UAlg/CLIMA-PESCA/environ-var/wind/Wind/tabular_data/"
...
for root, dirs, files in os.walk(dir):
    curr_var = root[-4:] # getting current variable: uwnd, vwnd or wspd 

    for file in files:
        if file.endswith(".csv"):
            curr_year = file[:4] # getting current year from file name
